...
@Repository
public interface InterpolRepository extends JpaRepository<InterpolEntity, Long> {

    @Query(value = "select * from interpol i where i.criminal_person ->> 'firstName' like :firstName or " +
    ...
    List<InterpolEntity> searchCriminalPerson(@Param("firstName") String firstName,
